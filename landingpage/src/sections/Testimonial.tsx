                ...
                <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-24">
                    ...
                    <div className="w-full lg:w-1/2 relative">
                        <div className="relative aspect-[4/3] rounded-[3rem] overflow-hidden rotate-[-2deg] shadow-2xl">
                            <Image
                                ...
                                fill
                                priority
                                className="object-cover rotate-[2deg] scale-110"
                            />
                        </div>
                    ...
                    <div className="w-full lg:w-1/2 text-center lg:text-left">
                        ...
                        <div className="relative inline-block text-gray-500 italic text-lg leading-relaxed mb-6">
                            <Quote
                                className="absolute -left-8 -top-2 text-gray-200"
                                size={40}
                            />
                            Customer service is really fast, and this developer
                            makes great quality themes! I would recommend this
                            theme for all Shopify platforms.
                        </div>
