...
const Footer = () => {
    return (
        <footer className="relative bg-[#F8F9FA] pt-20 pb-10 overflow-hidden">
            {/* Decorative Background Illustrations (Optional: Replace with actual images) */}
            ...
            <div className="container mx-auto px-4 xs:px-6 relative z-10">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
                    ...
                    <div className="lg:pl-10">
                        <h3 className="text-xl font-bold mb-6 relative inline-block">
                            About
                            <span className="absolute -bottom-1 left-0 w-8 h-1 bg-yellow-400"></span>
                        </h3>
                    ...
                    <div>
                        ...
                        <div className="space-y-4">
                            <input
                                ...
                                className="w-full px-6 py-4 rounded-xl border border-gray-100 bg-white focus:outline-none focus:ring-2 focus:ring-[#FF385C]/20 transition-all shadow-sm"
                            />
                ...
                {/* Bottom Bar */}
                <div className="mt-20 pt-8 border-t-4 border-yellow-400 flex flex-col md:row items-center justify-between gap-6">
                    <p className="text-sm font-bold text-gray-800">
                        <span className="text-[#FF385C]">© 2025 TasteNest</span>{" "}
                        | All shawanetc3 Themes
                    </p>
